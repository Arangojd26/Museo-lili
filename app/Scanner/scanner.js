...
const controlModalVideo = (contentQR) => {
  ...
  let contenido = document.getElementById("contenido").innerHTML = `<video autoplay id='videoQR'><source src='assets/vid/${contentQR}' type='video/mp4'></video>`;
  ...
  if(estado === 2){
    ...
    videoQR.onended = function () {
      ...
      maleta.classList.remove('d-none')
